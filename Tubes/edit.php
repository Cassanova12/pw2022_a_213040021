          ...
          <form action="" method="post" autocomplete="off" enctype="multipart/form-data">
            ...
            <input type="hidden" name="gambarLama" value="<?= $hewan["gambar"]; ?>">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="Nama" name="Nama" value="<?= $hewan["nama"]; ?>"> 
                </div>

                <div class="mb-3">
                  <label for="NamaLatin" class="form-label">Nama latin :</label>
                  <input type="text" class="form-control" id="NamaLatin" name="NamaLatin" value="<?= $hewan["nama_latin"]; ?>"> 
                </div>

                <div class="mb-3">
                  <label for="Jenis" class="form-label">Jenis :</label>
                  <input type="text" class="form-control" id="Jenis" name="Jenis" value="<?= $hewan["jenis"]; ?>"> 
                </div>

                <div class="mb-3">
                  <label for="Gambar" class="form-label">Gambar :</label>
                  <img src="img/<?= $hewan['gambar']; ?>" width="120"><br>
                  <input type="file" class="form-control" id="Gambar" name="Gambar" value="<?= $hewan["gambar"]; ?>"> 
                </div>

                <button type="submit" class="btn-primary" name="submit">Ubah data</button>
